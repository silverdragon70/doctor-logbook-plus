...
const FilterChip = ({ label, options, selected, onSelect }: {
  ...
  return (
    <div ref={ref} className="relative shrink-0">
      ...
      {open && (
        <div className="absolute top-full right-0 mt-1.5 w-[200px] bg-card border border-border rounded-xl overflow-hidden" style={{ zIndex: 9999, boxShadow: '0 8px 30px rgba(0,0,0,0.12)' }}>
          {options.map((o) => (
            <button
              key={o.key}
